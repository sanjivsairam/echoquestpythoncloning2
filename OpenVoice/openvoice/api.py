...
from wavmark.models import my_model
...
class ToneColorConverter(OpenVoiceBaseClass):
    ...
    def load_model(path="default"):
        if path == "default":
            local_cache_path = "./models/WavMark/step59000_snr39.99_pesq4.35_BERP_none0.30_mean1.81_std1.81.model.pkl"
            if not os.path.exists(local_cache_path):
                raise FileNotFoundError(
                    f"Model file not found locally at {local_cache_path}. Please download it first.")
            resume_path = local_cache_path
        else:
            resume_path = path
